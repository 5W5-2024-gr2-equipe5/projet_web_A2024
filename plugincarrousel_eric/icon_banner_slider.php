<?php
/*
Plugin Name: TIM LOGICIELS CARROUSEL BANDEROLE
...
ON peut les modifier dans le menu "Icon Banner Slider" dans l'admin de WordPress.
Version: 1.0
Author: Eric
*/

// Enregriste la page dans WordPress Admin
